    ...
    <div className="pt-28 pb-24">
      <div className="max-w-2xl mx-auto px-5 md:px-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            <p className="font-display uppercase font-extrabold text-sm mb-1">App Â« Carnet de terrain Â»</p>
            <p className="text-cr-dark/60 text-sm">
              Application dÃ©diÃ©e aux volontaires pour remonter les signalements depuis le terrain, mÃªme sans connexion internet.
            </p>
          </div>
