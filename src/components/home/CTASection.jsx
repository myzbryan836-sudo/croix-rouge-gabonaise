      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 grid md:grid-cols-2 gap-6">
        ...
        >
          <div>
            ...
            <p className="text-white/85 text-sm">Votre contribution finance directement nos interventions d'urgence et nos programmes de sant̩.</p>
          </div>
        ...
        >
          <div>
            ...
            <h3 className="font-display uppercase font-extrabold text-2xl mb-3">Devenir b̩n̩vole</h3>
            <p className="text-white/70 text-sm">Rejoignez un r̩seau de milliers de b̩n̩voles engag̩s partout au Gabon.</p>
          </div>
